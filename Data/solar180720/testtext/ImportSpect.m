function ImportSpect = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TESTFILE1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   TESTFILE1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   testfile1 = importfile('testfile1.txt', 1, 3648);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/07/24 13:11:54
...
ImportSpect = table(dataArray{1:end-1}, 'VariableNames', {'wavelength','intensity'});
